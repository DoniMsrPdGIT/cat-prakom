<div class="box">
    <div class="box-header with-header">
        ...
        <div class="pull-right">
            <a href="<?=base_url()?>soal_sosiokultural" class="btn btn-xs btn-flat btn-default">
                <i class="fa fa-arrow-left"></i> Kembali
            </a>
            <a href="<?=base_url()?>soal_sosiokultural/edit/<?=$this->uri->segment(3)?>" class="btn btn-xs btn-flat btn-warning">
