<div class="row">
    <div class="col-sm-12">    
        <?=form_open_multipart('soal_sosiokultural/save', array('id'=>'formsoal'), array('method'=>'add'));?>
        <div class="box">
    ...
    <div class="col-md-2">
        ...
        <input required="required" type="number" name="option_e" placeholder="Opsi E" id="option_e" class="form-control form-control-sm">
