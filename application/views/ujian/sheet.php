...
if(time() >= $soal->waktu_habis)
{
    if($soal->ujian_id>='401' && $soal->ujian_id<='480'){
        ...
        } else if ((($soal->ujian_id >= '6668' && $soal->ujian_id <= '6692')||($soal->ujian_id >= '6819' && $soal->ujian_id <= '6828')|| ($soal->ujian_id>='6875' && $soal->ujian_id<='6884'))) {
            redirect('ujian/list_twk', 'location', 301);
          } else if ((($soal->ujian_id >= '6698' && $soal->ujian_id <= '6722')||($soal->ujian_id >= '6834' && $soal->ujian_id <= '6843')|| ($soal->ujian_id>='6885' && $soal->ujian_id<='6894'))) {
            redirect('ujian/list_tiu', 'location', 301);
          } else if ((($soal->ujian_id >= '6728' && $soal->ujian_id <= '6752')||($soal->ujian_id >= '6865' && $soal->ujian_id <= '6874')|| ($soal->ujian_id>='6895' && $soal->ujian_id<='6904'))) {
