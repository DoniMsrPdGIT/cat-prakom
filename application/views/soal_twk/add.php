<div class="row">
    <div class="col-sm-12">    
        <?=form_open_multipart('soal_twk/save', array('id'=>'formsoal'), array('method'=>'add'));?>
        <div class="box">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input required="required" value="5" type="number" name="bobot" placeholder="Bobot Soal" id="bobot" class="form-control">
