<div class="row">
    <div class="col-sm-12">    
        <?=form_open_multipart('soal_manajerial/save', array('id'=>'formsoal'), array('method'=>'edit', 'id_soal'=>$soal->id_soal));?>
        <div class="box">
        ...
        <small class="help-block" style="color: #dc3545"><?=form_error('option_d')?></small>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group pull-right">
                                    <a href="<?=base_url('soal_manajerial')?>" class="btn btn-flat btn-default"><i class="fa fa-arrow-left"></i> Batal</a>
