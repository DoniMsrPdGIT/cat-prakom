        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    ...
                    <input value="<?=$data->nama_dosen?>" type="text" class="form-control" name="nama_dosen" placeholder="Nama Panitia">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input value="<?=$data->email?>" type="text" class="form-control" name="email" placeholder="Email Panitia">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="matkul">Bimbingan Teknis</label>
                    <select name="matkul" id="matkul" class="form-control select2" style="width: 100%!important">
                        <option value="" disabled selected>Pilih Bimbingan Teknis</option>
