...
class Ujian_model extends CI_Model {
    ...
    public function ambilSoal($pc_urut_soal1, $pc_urut_soal_arr,$Kodeujian)
    {
        ...
        ");
                ...
                $this->db->where('id_soal', $pc_urut_soal_arr);
                return $this->db->get()->row();
        }elseif((($Kodeujian>='6668' && $Kodeujian<='6692')||($Kodeujian>='6819' && $Kodeujian<='6828')|| ($Kodeujian>='6875' && $Kodeujian<='6884'))){
            $this->db->select("*, {$pc_urut_soal1} AS jawaban, jawaban AS kunci_soal_opsi, (SELECT CASE
            WHEN jawaban = 'A' THEN opsi_a
            WHEN jawaban = 'B' THEN opsi_b
            WHEN jawaban = 'C' THEN opsi_c
        ...
        ");
                ...
                $this->db->where('id_soal', $pc_urut_soal_arr);
                return $this->db->get()->row();
        }elseif((($Kodeujian>='6698' && $Kodeujian<='6722')||($Kodeujian>='6834' && $Kodeujian<='6843')|| ($Kodeujian>='6885' && $Kodeujian<='6894'))){
            $this->db->select("*, {$pc_urut_soal1} AS jawaban, jawaban AS kunci_soal_opsi, (SELECT CASE
            WHEN jawaban = 'A' THEN opsi_a
            WHEN jawaban = 'B' THEN opsi_b
            WHEN jawaban = 'C' THEN opsi_c
        ...
        ");
                ...
                $this->db->where('id_soal', $pc_urut_soal_arr);
                return $this->db->get()->row();
        }elseif((($Kodeujian>='6728' && $Kodeujian<='6752')||($Kodeujian>='6865' && $Kodeujian<='6874')|| ($Kodeujian>='6895' && $Kodeujian<='6904'))){
            $this->db->select("*, {$pc_urut_soal1} AS jawaban, jawaban AS kunci_soal_opsi, (SELECT CASE
            WHEN jawaban = 'A' THEN opsi_a
            WHEN jawaban = 'B' THEN opsi_b
            WHEN jawaban = 'C' THEN opsi_c
