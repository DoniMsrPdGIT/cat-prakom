...
class KelasDosen extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Angkatan Pelatihan',
			'subjudul'=> 'Data Angkatan Pelatihan'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Angkatan Pelatihan',
			'subjudul'	=> 'Tambah Data Angkatan Pelatihan',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Angkatan Pelatihan',
			'subjudul'		=> 'Edit Data Angkatan Pelatihan',
