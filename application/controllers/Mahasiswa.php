...
class Mahasiswa extends CI_Controller
{
	...
	public function validasi_mahasiswa($method)
	{
		...
		$this->form_validation->set_rules('nim', 'NIM', 'required|numeric|trim|min_length[16]|max_length[16]' . $u_nim);
	...
	public function modul(){
		...
		$data['view_modul'] = $this->Modul->view();
 		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('modul/up_modul/data');
		$this->load->view('_templates/dashboard/_footer.php');
	}
	...
	public function aksi_modul(){
		...
		$add = array('nama_modul' => $nm, 'isi_modul' => $file );
		$this->Modul->addmodul($add);
		redirect('Mahasiswa/modul','refresh');
	}
	...
	public function aksi_berkas(){
		...
		redirect('Mahasiswa/berkas','refresh');
	}
