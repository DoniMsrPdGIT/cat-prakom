...
class Soal_wawancara extends CI_Controller {
    ...
    public function index()
	{
		...
		$this->load->view('soal_wawancara/data');
...
$ujian_id = $id;
		...
		$data = [
			...
			'judul'	    => 'Soal',
            'subjudul'  => 'Edit Soal',
            'soal'      => $this->soal->getSoalByIdSoalWawancara($id),
        ];

        $this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('soal_wawancara/detail');
		$this->load->view('_templates/dashboard/_footer.php');
    }
    ...
    public function add()
	{
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('soal_wawancara/add');
		$this->load->view('_templates/dashboard/_footer.php');
    }
...
$ujian_id = $id;
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('soal_wawancara/edit');
		$this->load->view('_templates/dashboard/_footer.php');
	}

	public function data($id=null, $dosen=null)
	{
		$this->output_json($this->soal->getDataSoalWawancara($id, $dosen), false);
    }
    ...
    public function save()
    {
        ...
        if($this->form_validation->run() === FALSE){
            ...
            foreach ($_FILES as $key => $val) {
                ...
                $getsoal = $this->soal->getSoalByIdSoalWawancara($this->input->post('id_soal', true));
            ...
            if($method==='add'){
                ...
                //insert data
                $this->master->create('tb_soal_wawancara', $data);
            }else if($method==='edit'){
                //push array
                $data['updated_on'] = time();
                //update data
                $id_soal = $this->input->post('id_soal', true);
                $this->master->update('tb_soal_wawancara', $data, 'id_soal', $id_soal);
            }else{
    ...
    public function delete()
    {
        ...
        if(!$chk){
            ...
            if($this->master->delete('tb_soal_wawancara', $chk, 'id_soal')){
