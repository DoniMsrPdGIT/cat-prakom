...
class JurusanMatkul extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Tema Pelatihan',
			'subjudul'=> 'Data Tema Pelatihan'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Tema Pelatihan',
			'subjudul'	=> 'Tambah Data Tema Pelatihan',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Tema Pelatihan',
			'subjudul'		=> 'Edit Data Tema Pelatihan',
