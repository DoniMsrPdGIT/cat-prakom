...
class Soal_tkp extends CI_Controller {
...
$ujian_id = $id;
		...
		$data = [
			...
			'judul'	    => 'Soal',
            'subjudul'  => 'Edit Soal',
            'soal'      => $this->soal->getSoalByIdSoalTkp($id),
        ];

        $this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('soal_tkp/detail');
		$this->load->view('_templates/dashboard/_footer.php');
    }
...
$ujian_id = $id;
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('soal_tkp/edit');
		$this->load->view('_templates/dashboard/_footer.php');
	}

	public function data($id=null, $dosen=null)
	{
		$this->output_json($this->soal->getDataSoalTkp($id, $dosen), false);
    }
    ...
    public function save()
    {
        ...
        if($this->form_validation->run() === FALSE){
            ...
            foreach ($_FILES as $key => $val) {
                ...
                $getsoal = $this->soal->getSoalByIdSoalTkp($this->input->post('id_soal', true));
            ...
            if($method==='add'){
                ...
                //insert data
                $this->master->create('tb_soal_tkp', $data);
            }else if($method==='edit'){
                //push array
                $data['updated_on'] = time();
                //update data
                $id_soal = $this->input->post('id_soal', true);
                $this->master->update('tb_soal_tkp', $data, 'id_soal', $id_soal);
            }else{
    ...
    public function delete()
    {
        ...
        if(!$chk){
            ...
            if($this->master->delete('tb_soal_tkp', $chk, 'id_soal')){
