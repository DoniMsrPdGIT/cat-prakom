  ...
  table = $("#soal").DataTable({
    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          return `<div class="text-center">
                                <a href="${base_url}soal_tiu/detail/${data}" class="btn btn-xs btn-default">
                                    <i class="fa fa-eye"></i> Detail
                                </a>
                                <a href="${base_url}soal_tiu/edit/${data}" class="btn btn-xs btn-warning">
