...
$(document).ready(function () {
    ...
    table = $("#ujian").DataTable({
        ...
        serverSide: true,
        ajax: {
            "url": base_url+"ujian/list_twk_json",
            "type": "POST",
        },
        columns: [
            {
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    if (data.tot_toman <= 9 ) {
                        ...
                        btn = `<a class="btn btn-xs btn-warning" href="${base_url}DataPeserta/reset_twk/01930304023${data.mahasiswa_id}49203324"><i class="fa fa-refresh"></i> Reset</a>
						`;
                    }
                    }
                    return `<div class="text-center">
