...
$(document).ready(function () {
    ...
    table = $("#ujian").DataTable({
        ...
        serverSide: true,
        ajax: {
            "url": base_url+"ujian/list_sosio_json",
            "type": "POST",
        },
        columns: [
            {
            ...
            { 
                ...
                "render": function(data, type, row, meta) {
                    return 'Seleksi Kompetensi Sosiokultural - PPPK';
                }
            },
            { "data": 'nama_dosen' },
            { "data": 'jumlah_soal' },
...
<a class="btn btn-xs btn-warning" href="${base_url}ujian/pembahasan/01930304023${data.id}49203324">
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    if (data.ada > 0) {
                        btn = `<a class="btn btn-xs btn-warning" href="${base_url}DataPeserta/reset_sosio/01930304023${data.id}49203324"><i class="fa fa-refresh"></i> Reset</a>
						`;
						} else {
