...
$(document).ready(function() {
  ...
  table = $("#soal").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: base_url + "soal_wawancara/data",
      type: "POST"
    },
    columns: [
      {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          return `<div class="text-center">
                                <a href="${base_url}soal_wawancara/detail/${data}" class="btn btn-xs btn-default">
                                    <i class="fa fa-eye"></i> Detail
                                </a>
                                <a href="${base_url}soal_wawancara/edit/${data}" class="btn btn-xs btn-warning">
